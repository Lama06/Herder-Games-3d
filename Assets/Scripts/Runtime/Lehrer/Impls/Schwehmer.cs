    ...
    public class Schwehmer : Lehrer
    {
        ...
        protected override void RegisterFragen(InteraktionsMenuFragenManager fragen)
        {
            ...
            fragen.AddFrage(new InteraktionsMenuFrageEinfach(
                ...
                antworten: new SaetzeMoeglichkeitenEinmalig(
                    "Danke dir! Meine sind mir gerade ausgegangen und ich hatte schon Angst dass meine Lunge sich mal ein paar Minuten erholen kann!")
            ));
        }
        ...
        protected override void RegisterGoals(AIController ai)
        {
            ...
            var gehenAnimation = new SimpleAnimation(AnimationName.Gehen);

            var unterrichtenAnimationNormal = new RepeatAnimation(new ShuffleAnimation(
                new ShuffleAnimation.Choice(10, new SimpleAnimation(AnimationName.Reden, 7f)),
                new ShuffleAnimation.Choice(2, new SimpleAnimation(AnimationName.RedenAggressiv, 7f)),
                new ShuffleAnimation.Choice(1, new SimpleAnimation(AnimationName.Stehen, 7f))
            ));

            var unterrichtenAnimationKeinInternet = new RepeatAnimation(new ShuffleAnimation(
                new ShuffleAnimation.Choice(10, new SimpleAnimation(AnimationName.RedenAggressiv, 7f)),
                new ShuffleAnimation.Choice(2, new SimpleAnimation(AnimationName.Reden, 7f)),
                new ShuffleAnimation.Choice(1, new SimpleAnimation(AnimationName.Stehen, 7f))
            ));

            var unterrichtenAnimationKrank = new RepeatAnimation(new ShuffleAnimation(
                new ShuffleAnimation.Choice(10, new SimpleAnimation(AnimationName.Stehen, 7f)),
                new ShuffleAnimation.Choice(2, new SimpleAnimation(AnimationName.RedenAggressiv, 7f)),
                new ShuffleAnimation.Choice(1, new SimpleAnimation(AnimationName.Stehen, 7f))
            ));
            ...
            void Unterrichten(WoechentlicheZeitspannen wann, UnterrichtenGoal.StundenData stunde)
            {
                ai.AddGoal(new UnterrichtenGoal(
                    ...
                    trigger: new CallbackTrigger(() =>
                        wann.IsInside(TimeManager) && Vergiftung is {Syntome: true, VergiftungsType: VergiftungsType.Normal}),
                ...
                trigger: new ZeitspanneTrigger(
                    ...
                    new WoechentlicheZeitspannen(
                        new WoechentlicheZeitspannen.Eintrag(
                            ...
                            new WoechentlicheZeitspannen.Zeitspanne(
                                new WoechentlicheZeitspannen.Zeitpunkt(new StundeZeitRelativitaet(StundenType.Mittagspause, AnfangOderEnde.Anfang),
                                    0f),
            ...
            FakeUnterrichten(new WoechentlicheZeitspannen(Wochentag.Mittwoch, StundenType.Lernzeit, 0, unterrichtVerspaetung,
                unterrichtUeberziehung));
            ...
            FakeUnterrichten(new WoechentlicheZeitspannen(Wochentag.Donnernstag, StundenType.Lernzeit, 0, unterrichtVerspaetung,
                unterrichtUeberziehung));
