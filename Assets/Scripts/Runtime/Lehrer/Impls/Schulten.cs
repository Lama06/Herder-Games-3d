...
namespace HerderGames.Lehrer.Impls
{
    public class Schulten : Lehrer
    {
        ...
        protected override void RegisterGoals(AIController ai)
        {
            ...
            RauchenGehenVorne(new WoechentlicheZeitspannen(Wochentag.Mittwoch, StundenType.Mittagspause, 0, unterrichtUeberziehung,
                unterrichtVerspaetung));
            ...
            RauchenGehenVorne(new WoechentlicheZeitspannen(Wochentag.Donnernstag, StundenType.Mittagspause, 0, unterrichtUeberziehung,
                unterrichtVerspaetung));
